...
The revenue from lettuce production is proportional to the change in biomass between the initial state~\(x(0)\) and the current state~\(x(t)\), expressed as:
\begin{equation}
    R(t) = \frac{P_L A_c}{\rho_{dw}} \textstyle\sum_{i\in \{ \text{sdw}, \text{nsdw} \}}(x_i(t) - x_i(0)),
\end{equation}
